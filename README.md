...
// @version      version0
// @description  By CloudyPlays#2006
// @author       CloudyPlays#2006
// @match        *://moomoo.io/*
// @match        *://dev.moomoo.io/*
// @match        *://sandbox.moomoo.io/*
...
// @require https://code.jquery.com/ui/1.12.0/jquery-ui.min.js
// @require https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.0/jquery-confirm.min.js
// @icon    https://www.google.com/imgres?imgurl=https%3A%2F%2Fi.ytimg.com%2Fvi%2FGdmo-YIaeT4%2Fmaxresdefault.jpg&imgrefurl=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DGdmo-YIaeT4&tbnid=mPCIgFNsCOFK_M&vet=10CBcQxiAoAmoXChMIoPuv0sT16gIVAAAAAB0AAAAAEAg..i&docid=XJl3Cs4oFKbwHM&w=1280&h=720&itg=1&q=moomoo.io&client=opera-gx&ved=0CBcQxiAoAmoXChMIoPuv0sT16gIVAAAAAB0AAAAAEAg
// @downloadURL none
// ==/UserScript==
...
newImg.src = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwallpapercave.com%2Fmoomooio-wallpapers&psig=AOvVaw3JkfsC93LdH2dyBD9gc2t_&ust=1596275856237000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCOig9oyd9-oCFQAAAAAdAAAAABAF";
newImg.style = `position: absolute; top: 30px; left: 30px; z-index: 100000; width: 100px; height: 100px; cursor: pointer;`;
document.body.prepend(newImg);
newImg.addEventListener("click", () => {
       let w = window.open("https://www.youtube.com/channel/UCHjK8tAd6EuzPmtcOxYb5dw?view_as=subscriber", null, `height=650, width=1199, status=yes, toolbar=no, menubar=no, location=no`);
});
$("#gameCanvas").css('cursor', 'url(http://cur.cursors-4u.net/user/use-1/use153.cur), default');

$("#consentBlock").css({display: "none"});
//$("#youtuberOf").css({display: "none"});
$("#mapDisplay").css({background: `url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fwallpapercave.com%2Fmoomooio-wallpapers&psig=AOvVaw1LtnG9AZyWakC_aEw5eZyd&ust=1596216396740000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCPiR1sq_9eoCFQAAAAAdAAAAABAF')`});
...
$("#chatButton").css({background: `url('https://www.google.com/search?q=image+277x182+green&tbm=isch&ved=2ahUKEwiejqjgmPfqAhVLzioKHW5fCnAQ2-cCegQIABAA&oq=image+277x182+black&gs_lcp=CgNpbWcQA1DHIFjqJmDCKGgAcAB4AIABUogBuwOSAQE2mAEAoAEBqgELZ3dzLXdpei1pbWfAAQE&sclient=img&ei=guYjX57FE8ucqwHuvqmABw&bih=1087&biw=1528&client=opera-gx&hs=QvU#imgrc=caPpS0ppN2jk6M')`});
$("#storeButton").css({background: `url('https://www.google.com/search?q=image+277x182+black&tbm=isch&ved=2ahUKEwiejqjgmPfqAhVLzioKHW5fCnAQ2-cCegQIABAA&oq=image+277x182+black&gs_lcp=CgNpbWcQA1DHIFjqJmDCKGgAcAB4AIABUogBuwOSAQE2mAEAoAEBqgELZ3dzLXdpei1pbWfAAQE&sclient=img&ei=guYjX57FE8ucqwHuvqmABw&bih=1087&biw=1528&client=opera-gx&hs=QvU#imgrc=caPpS0ppN2jk6M')`});
...
if(e.keyCode == 67 && document.activeElement.id.toLowerCase() !== 'chatbox') {
   ...
   if(e.keyCode == 112 && document.activeElement.id.toLowerCase() !== 'chatbox') {
       ...
       if(healToggle == 0) {
        ...
        if (autoaim == false) {
            autoaim = true;
        document.title = "CloudyMoD / Aim : On";
        } else {
        document.title = "CloudyMoD / Aim : Off";
            autoaim = false;
    }
    }
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" style="font-size: 17px;">
            <div class="flexControl">
                <h3 style="color: Blue; font-size: 17px;"></h3>
        ...
        <div class="modal-footer">
            <h3 style="font-size: 17px;">DO NOT SHARE THIS HACK OR THE PASSWORD!</h3>
            <p>CloudyHonorsYou</p>
        </div>
    </div>
</div>
...
document.getElementById('enterGame').innerHTML = '| PLAY AND KILL THEM |';
document.getElementById("gameName").style.color = "Yellow";
document.getElementById('loadingText').innerHTML = '. . . . . . . . . Load M̶̧̳̭̳͇͎̫͇̪̰̈́̒̈́a̷̮̤̙̼͕̦̐̓̓̉͋̕͝ͅK̵̛̼͚͇̱̫͓͊̆̑̿̒̉̅́͘͝͠ẻ̴͔̓̈͂́͝ͅĆ̷̱̘̠̲̤̽l̴̨̧̹̹̮̤̘̪̭͒͑̐͆̃͘͜ǫ̶̧̛̖͉͎͍̗͇͙̻̜̹̥̼̦̾̾̿̐̂Ų̸̞̺̮̦̠̞̤͎̪̯̣̈͐͆̚͝D̶̨̦̘̥̻͎̝̱͖͍̦̲̲̀̇̓̒͑̃́͒̄̃́̂͒͘͝y̵̱͓̬̫͔̣̥̾̅̋͐̕͝M̷̠̻̙̲̳̼̺̿̾͠ͅo̶̳̻̞̲͖̖̘̟̗̲͉̟̭̫̅͂̀͑̈͘̕D̶̘̹̩̙̼̹͈̣͕̈̍͛̃̉́͑̇͜ǫ̸͕̦̪͍̟̻̗̹̰͙̩̭͖̈́̈́͌̄̊̓́̒̃̉̏̎͒͠͠n̷̢̨̙̖͔͕̜̣͔̣̾̈̈́̇̚͝T̶̛̠͍̠̗͆͆̈̌́͗́̌͘ổ̸̙̳͔͓̠̐͗̊͛̇͐̔͊̉̚P̷̰̃ . . . . . . . . . .';
document.getElementById('nameInput').placeholder = "CloudyPro";
document.getElementById('chatBox').placeholder = "CloudyPro";
document.getElementById("pingDisplay").style.color = "Yellow";
document.getElementById('diedText').innerHTML = 'Game Over. u will get him next time!';
document.getElementById('diedText').style.color = "Yellow";

document.getElementById("storeHolder").style = "height: 1500px; width: 400px;"
...
document.getElementById('gameName').innerHTML = 'CloudyMoD';
...
$('#gaProject BooMmeCanvas').css({'background-color': '#f4f4f4'});
...
document.getElementById('diedText').innerHTML = '💢Let Ravange!💢';
document.getElementById('loadingText').innerHTML = '...LoaDinG CloudyMoD...';
...
while(response != password && !error){
    if(entryCount < entryLimit){
        response = window.prompt("☁️↓Enter Password↓☁️");
        entryCount++;
    } else {
        error = true;
    }
...
setTimeout( () => {
    setInterval(() => {
    setTimeout(() => {
        document.getElementById("gameName").innerHTML = "CloudyM_D"
        setTimeout(() => {
            document.getElementById("gameName").innerHTML = "CloudyMo_"
            setTimeout(() => {
                document.getElementById("gameName").innerHTML = "CloudyMoD"
                setTimeout(() => {
                    document.getElementById("gameName").innerHTML = "_loudyMoD"
                    setTimeout(() => {
                        document.getElementById("gameName").innerHTML = "C_oudyMoD"
                        setTimeout(() => {
                            document.getElementById("gameName").innerHTML = "Cl_udyMoD"
                            setTimeout(() => {
                                document.getElementById("gameName").innerHTML = "Clo_dyMoD"
                                setTimeout(() => {
                                    document.getElementById("gameName").innerHTML = "Clou_yMoD"
                                    setTimeout(() => {
                                        document.getElementById("gameName").innerHTML = "Cloud_MoD"
                                        setTimeout(() => {
                                            document.getElementById("gameName").innerHTML = "Cloudy_oD"
                                            setTimeout(() => {
                                                document.getElementById("gameName").innerHTML = "CloudyM_D"
                                                setTimeout(() => {
                                                    document.getElementById("gameName").innerHTML = "CloudyMo_"
